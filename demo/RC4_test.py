...
if __name__ == "__main__":
    ...
    # print("\nOutput:")
    # txtENC = RC4_Module.RC4_Encrypt(False, 'The quick brown fox fumps over the lazy dog!!!!!', 'startrekwasbeter')
    # print("Encrypted text: ",txtENC)
    # txtDEC = RC4_Module.RC4_Decrypt(False, txtENC, 'startrekwasbeter')
    ...
    p_File = Image.open('berge_500.png')
    p_img = np.asarray(p_File)
    imgENC = RC4_Module.RC4_Encrypt(False, p_img, 'startrekwasbeter')
    print("Encryption Done!")
    Image.fromarray(imgENC.astype(np.uint8)).save('berge_encrypted_RC4.png')
    imgDEC = RC4_Module.RC4_Decrypt(False, imgENC, 'startrekwasbeter')
    ...
    print("\nInput:")
    print("Key: StefanJacobus")
    p_File = Image.open('gebou_500.png')
    p_img = np.asarray(p_File)
    imgENC = RC4_Module.RC4_Encrypt(False, p_img, 'startrekwasbeter')
    print("Encryption Done!")
    Image.fromarray(imgENC.astype(np.uint8)).save('gebou_encrypted_RC4.png')
    imgDEC = RC4_Module.RC4_Decrypt(False, imgENC, 'startrekwasbeter')
    Image.fromarray(imgDEC.astype(np.uint8)).save('gebou_decrypted_RC4.png')
    print("Decryption Done!")
    ...
    imgENC = RC4_Module.RC4_Encrypt(False, p_img, 'startrekwasbeter')
    print("Encryption Done!")
    Image.fromarray(imgENC.astype(np.uint8)).save('EHN_encrypted_RC4.png')
    imgDEC = RC4_Module.RC4_Decrypt(False, imgENC, 'startrekwasbeter')
    Image.fromarray(imgDEC.astype(np.uint8)).save('EHN_decrypted_RC4.png')
    print("Decryption Done!")
